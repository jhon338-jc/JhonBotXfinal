...
export function tmpName(ext, prefix = 'tmp') {
    return `${prefix}_${Date.now()}_${process.pid}_${Math.random().toString(36).slice(2, 8)}.${ext}`
}

async function saveMedia(buffer, dir = '') {
    try {
