...
let handler = async (m, { conn, args }) => {
    ...
    msg += '\n\n_Nomor ini menjadi *member premium*, bukan owner. Akses premium berakhir otomatis setelah waktu habis selama server nyala._\n_Untuk owner asli (tanpa batas waktu): `.ownadd`._'
    m.reply(msg)
}
