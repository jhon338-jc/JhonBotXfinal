...
const GAME_JS = `
var H={war:{n:'Warrior',e:'🛡️',hp:140,atk:18,mp:40},mag:{n:'Mage',e:'🧙',hp:90,atk:26,mp:100},rog:{n:'Rogue',e:'🗡️',hp:110,atk:22,mp:60}};
...
if(def){d=Math.max(1,Math.floor(d/2));logT('🛡️ Defend mengurangi DMG ke '+d)}
hero.hp-=d;
...
document.getElementById('atk').onclick=function(){act(function(){var d=rnd(hero.atk-4,hero.atk+6);ene.hp-=d;logT('⚔️ '+hero.n+' ATTACK, DMG '+d);return true})};
...
document.getElementById('defB').onclick=function(){act(function(){def=true;logT('🛡️ '+hero.n+' bersiap defend');return true})};
