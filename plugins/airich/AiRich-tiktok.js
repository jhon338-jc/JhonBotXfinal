...
const GAME_JS = `
const VC=[{c:'TikTok AI Rich demo 🚀',g:'linear-gradient(165deg,#fe2c55,#6c5ce7)',fx:['💜','✨','⭐','💫','🔥']},{c:'Glassmorphism trend ✨',g:'linear-gradient(165deg,#25f4ee,#6c5ce7)',fx:['💙','❄️','✨','💎','💫']},{c:'Tap the heart 💖',g:'linear-gradient(165deg,#f7b733,#fc4a1a)',fx:['❤️','✨','🪩','⭐','💛']}];
...
let handler = async (m, { conn }) => {
    ...
    try {
        const html = shell({ title: 'TikTok', tag: 'APP', icon: '📱', html: '<div style="font-family:Arial;color:#fff"><div style="text-align:center;font-size:13px;letter-spacing:2px;color:rgba(255,255,255,.6);margin-bottom:10px">TIKTOK</div>' +
                ...
                '<div id="heart" style="text-align:center;cursor:pointer;filter:drop-shadow(0 2px 4px rgba(0,0,0,.5))"><div>❤️</div><div id="hc" style="font-size:12px;font-weight:bold">0</div></div>' +
