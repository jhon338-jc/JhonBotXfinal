...
let handler = async (m, { conn }) => {
    try {
        const html = shell({ title: 'Poker', tag: 'APP', icon: '', html: '<div id="cards" class="row" style="gap:4px"></div><div id="act" class="muted" style="text-align:center;margin:10px 0;min-height:16px"></div><div class="row" style="justify-content:center"><button class="btn" id="deal" style="background:#6c5ce7">DEAL</button><button class="btn" id="drawB" style="background:#0dbd8b">DRAW</button></div>', script: GAME_JS })
