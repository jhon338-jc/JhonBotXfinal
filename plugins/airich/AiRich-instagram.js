...
function burst(){var h=document.createElement('div');h.textContent='❤️';h.style.cssText='position:absolute;left:50%;top:45%;font-size:56px;transform:translate(-50%,-50%);animation:pop .8s ease-out forwards';hearts.appendChild(h);setTimeout(function(){h.remove()},800)}
var lastT=0;
...
function update(){countEl.textContent=likes.toLocaleString()+' likes';likeBtn.textContent=liked?'❤️':'🤍'}
var cm=0;
