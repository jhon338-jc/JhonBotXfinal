...
let handler = async (m, { conn }) => {
    ...
    try {
        const html = shell({ title: 'SoundCloud', tag: 'APP', icon: '🎚️', html: '<div style="font-family:Arial;color:#fff"><div style="text-align:center;font-size:13px;letter-spacing:2px;color:rgba(255,255,255,.6);margin-bottom:10px">SOUNDCLOUD</div>' +
