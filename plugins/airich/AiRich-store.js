...
<div id="app">
  <div style="display:flex;align-items:center;gap:10px">
    <div style="flex:1;font-size:16px;font-weight:bold;color:#fff"> AI Store</div>
...
const GAME_JS = `
var products=[['Arcade Blast','Games',12,'','#6c5ce7'],['Puzzle Pro','Games',8,'','#0984e3'],['Task Manager','Tools',15,'','#e17055'],['Neon Lamp','Decor',22,'','#00b894'],['Speed Racer','Games',19,'','#e0245e'],['Note Pad','Tools',6,'','#f9a825'],['Cozy Sofa','Decor',18,'','#8e44ad'],['Crypto Calc','Tools',25,'','#00cec9']];
