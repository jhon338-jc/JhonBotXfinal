...
let handler = async (m, { conn, command }) => {
    const apps = {
        hanime: () => kyzzApi.anime.hanimeTrending(),
        hentaigenres: () => kyzzApi.anime.hentaiTvGenres(),
        hentaitrending: () => kyzzApi.anime.hentaiTvTrending()
    }
...
handler.command = ['hanime', 'hentaigenres', 'hentaitrending']
